      ...
      <div class="page">
        ...
        <div class="img_aggregate">
          ...
          <div class="sao">
            ...
            <span class="text">请使用支付宝扫一扫扫描二维码支付</span>
          </div>
          <img class="wechatpay_home" src="@/assets/images/shopping_cart/alipay_home.png" alt="">
          <img class="wechatpay_scan" src="@/assets/images/shopping_cart/alipay_scan.png" alt="">
        </div>
      </div>
...
export default {
  ...
  methods: {
    // 刷新二维码
    async refreshQR() {
      const res = this.reqPayInfo(this.orderNo)
      if (res) {
    ...
    async reqPayInfo(orderNo) {
      ...
      if (res.code === 200) {
        ...
        this.expireTime = Date.parse(new Date(res.data.refreshEndTime)) / 1000
