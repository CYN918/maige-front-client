<template>
  <div id="all_order_tab" class='after-sales'>
    <el-table
      :data="tableData"
        ...
        <template slot-scope="scope">
          <div class="order_no">
            ...
            <div class="button">
              ...
              <!-- <el-button class="text" type="primary" size="mini" v-if="scope.row.payStatus ==2 && scope.row.orderStatus  == 5 && (scope.row.hadComment==0 || scope.row.hadComment==2) && scope.row.afterSaleStatus == 0"   @click="complefunc(scope.row)">申请售后</el-button> -->
