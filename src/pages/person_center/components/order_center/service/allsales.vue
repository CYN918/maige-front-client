<template>
  <div>
    <div class="mcard" id="myorder">
      <div class="allorder">
        <el-table :data="tableData" border stripe @row-click="aftergoodslistc" style="width:100%">
          ...
          <el-table-column label="操作" align="center" width="160">
            <template slot-scope="scope">
              ...
              <div
                ...
                v-if="(scope.row.returnType == 0 || scope.row.returnType == 1 || scope.row.returnType == 2) && scope.row.checkAfterStatus==1 && scope.row.returnLogisticNo==null &&(scope.row.agencyStatus ==1 || scope.row.agencyStatus ==2 || scope.row.agencyStatus ==3)"
              >
                <div class="i-div">
              ...
              <div
                class="small-Idiv"
                @click.stop="upgradefunc(scope.row)" v-if="scope.row.agencyStatus == 1 || scope.row.agencyStatus  == 2 || scope.row.agencyStatus  == 3"
              >
                <div class="i-div">
              ...
              <div class="small-Idiv" @click.stop="upgradefunc(scope.row,true)" v-if="(scope.row.supplierStatus == 4 && scope.row.agencyStatus==4) || (scope.row.supplierStatus == 6 && scope.row.agencyStatus==6)">
                  <div class="i-div">
          ...
          <el-table-column label="操作" align="center" width="150">
            <template slot-scope="scope">
                ...
                <!-- <div
                  ...
                  v-if="checkobj.checkAfterStatus == 1 && (checkobj.returnType==1 || checkobj.returnType==2)&& (scope.row.returnLogisticNo != null && scope.row.returnLogisticNo != '') && (scope.row.receiveShippingTime == '' || scope.row.receiveShippingTime == null )"
                >
                  <div class="i-div">
                  </div>
                  <span>发货</span>
...
import { aftersalepagec , findpicc , aftergoodslistc , findlogisticsdetailc , cancelafterSale } from "@/api/sales";
