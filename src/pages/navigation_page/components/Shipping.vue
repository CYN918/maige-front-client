<template>
    <div class="inner">
        <div class="content">
            <div class="left_nav">
                <ul class="left">
                    <router-link class="left_li" @click="handleLine(0)" :class="this.lineIndex==0?'active':''"  tag="li" :to='{path:"/"}' >
            ...
            <div class="right">
                <div class="right_title">
                    <h3><span class="slectStatus"></span>配送方式</h3>
                </div>
                <div class="right_nav">
                    <ul class="right_line">
                        <li  @click="handleRightLine(0)" :class="this.rightIndex==0?'liActive':''">
                            <img  class="right_img" src="@/assets/images/navigation_page/shipping/shipping_03.jpg" alt=""/>
                            快递查询
                        </li>
                        <li @click="handleRightLine(1)" :class="this.rightIndex==1?'liActive':''">
                            <img  class="right_img" src="@/assets/images/navigation_page/shipping/shipping_05.jpg" alt=""/>
                            上门自取
                        </li>
                        <li @click="handleRightLine(2)" :class="this.rightIndex==2?'liActive':''">
                            <img  class="right_img" src="@/assets/images/navigation_page/shipping/shipping_07.jpg" alt=""/>
                            配送范围
                        </li>
                        <li @click="handleRightLine(3)" :class="this.rightIndex==3?'liActive':''">
                            <img  class="right_img" src="@/assets/images/navigation_page/shipping/shipping_09.jpg" alt=""/>
                            配送收费支付标准
                        </li>
