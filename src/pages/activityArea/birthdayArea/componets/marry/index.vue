<template>
  <div>
    ...
    <div class="birthday-card">
      <h3 class="birthday-card-title">结婚</h3>
        ...
        <li class="birthday-card-01">
          <div class="user-wrap">
            <div class="avantar-wrap">
              ...
              <img class="birthday-avantar" src='@/assets/images/birthdayArea/avantar_wedding.png' alt="结婚" />
            </div>
            <div class="birthday-name-wrap">
              <span class="birthday-name">{{marryPersonal.userName}}</span>
              <img
                class="icon-button"
      ...
      <div class="pop-up">
        ...
        <ul class="pop-up-content clearfix">
          ...
          >
            ...
            <img class="select-avantar-pic" src='@/assets/images/birthdayArea/avantar_wedding.png' alt />
...
export default {
  ...
  computed:{
    ...mapState(['marryPersonal','marryUserId','gifterUserId'])
  },
  methods:{
    //选择人物
    clilkpersonal(index) {
      this.num = index;
      this.$store.commit('marryUserId',this.userInfo[this.num].userId)
    },
    //控制弹窗
    isshowMsg() {
      this.ishow = true;
    ...
    async gilr() {
      ...
      const obj = {
        ...
        happyEventType:2,   //活动类型
        userId:this.marryUserId ,  //评论者id
        presentType:1     //祝福类型
      }
  ...
  async  showMsg() {
      this.ishow = false;
      this.$store.commit('marryPersonal',this.userInfo[this.num])
      const  obj = {
          activityId: this.activityId,
          userId: this.marryUserId,
          happyEventType:2,
      }
    ...
    pickGift(){
      ...
      this.$router.push('/pickGiftmarry')
    },
    //打赏红包
    redEnvelope(){
      if(!this.marryUserId){
      ...
      this.$router.push('/redEnvelopemarry')
    },
    //祝福留言
    blessingMessage(){
      if(!this.marryPersonal){
        this.$message({
              type: 'info',
              message: `请选择人物`
            });
