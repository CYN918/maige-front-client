      ...
      <div>
        <el-form ref="ruleForm" label-width="100px" class="demo-ruleForm" :model="ruleForm" :rules="rules">
          <div>
            ...
            <el-row>
              <el-col :span="8">
                <el-form-item label="提交人：" prop="resource" label-width="100px">
                  {{ruleForm.sumbitUserName}}
                </el-form-item>
              </el-col>
              <el-col :span="8">
                <el-form-item label="部门：" prop="resource" label-width="100px">
                  {{ruleForm.sumbitOrganizeName}}
                </el-form-item>
              </el-col>
              <el-col :span="8">
                <el-form-item label="职位：" prop="resource" label-width="100px">
                  {{ruleForm.sumbitRoleName}}
                </el-form-item>
              </el-col>
            </el-row>
            <el-form-item label="提交说明：" prop="resource">
              {{ruleForm.questionDesc}}
            </el-form-item>
          </div>
          ...
          <div>
            ...
            <div>
              <el-row>
                <el-col :span="8">
                  <el-form-item label="审批人：" prop="resource" label-width="100px">
                    {{ ruleForm.roles && ruleForm.roles[0].auditUserName}}
                  </el-form-item>
                </el-col>
                <el-col :span="8">
                  <el-form-item label="部门：" prop="organizeName" label-width="100px">
                    <el-select v-model="ruleForm.organizeName" placeholder="请选择" @change="changeorgan">
                      <el-option
...
export default {
  ...
  methods: {
    async loadOptions({ action, parentNode, callback, instanceId  }) {
      ...
      const data = await getchildnode(parentNode.id)
      console.log(data)
      ...
      this.$refs.ruleForm.validate(async valid => {
          if (valid) {
            const obj = {
              ...
              sysUserId: this.ruleForm.sysUserId,
              sysUserName: this.ruleForm.sysUserId
            }
