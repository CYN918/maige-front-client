      ...
      <div class="allorder">
        <el-table :data="tableData" border stripe @row-click="aftergoodslistc">
          ...
          <el-table-column label="进度说明" align="center" width="130">
            <template slot-scope="scope">
              <div class="txt_left">申请人：{{scope.row.customerName}}</div>
              <div class="txt_left">
          ...
          <el-table-column label="操作" align="center" width="160">
            <template slot-scope="scope">
              ...
              <div class="small-Idiv" @click.stop="upgradefunc(scope.row,true)" v-if="scope.row.supplierStatus == 4 && scope.row.agencyStatus == 4">
                  <div class="i-div">
