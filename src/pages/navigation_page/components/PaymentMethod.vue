        ...
        <div class="content">
            ...
            <div class="right">
                <div class="right_title">
                    <h3><span class="slectStatus"></span>支付方式</h3>
                </div>
                <div class="right_nav">
                    <ul class="right_line">
                        <li  @click="handleRightLine(0,$event)" :class="this.rightIndex==0?'liActive':''">
                            <img  class="right_img" src="@/assets/images/navigation_page/paymentMethod/paymentMethod_03.jpg" alt=""/>
                            货到付款
                        </li>
                        <li @click="handleRightLine(1,$event)" :class="this.rightIndex==1?'liActive':''">
                            <img  class="right_img" src="@/assets/images/navigation_page/paymentMethod/paymentMethod_05.jpg" alt=""/>
                            支付宝付款
                        </li>
                        <li @click="handleRightLine(2,$event)" :class="this.rightIndex==2?'liActive':''">
                            <img  class="right_img" src="@/assets/images/navigation_page/paymentMethod/paymentMethod_07.jpg" alt=""/>
                            微信付款
                        </li>
                        <li @click="handleRightLine(3,$event)" :class="this.rightIndex==3?'liActive':''">
                            <img  class="right_img" src="@/assets/images/navigation_page/paymentMethod/paymentMethod_09.jpg" alt=""/>
                            对公转账
                        </li>
