  ...
  <div style="padding-bottom: 20px;">
    ...
    <div>
      ...
      <div class="saveAddress">
        <p>
          <i></i>
          <span>已保存{{singleAddress.length}}了条地址 , 还能保存{{20-singleAddress.length}}条地址</span>
        </p>
      </div>
      <!--多地址-->
...
<style lang="stylus" scoped>
  ...
  .saveAddress
    ...
    i
      ...
      width 25px
      height 25px
      background url("~@/assets/images/person_center/image/tanhao.png")
...
<script>
  import { reqDeleteAddress, confirmOrderFromShoppingCart, findAddressById, confirmOrderFromJustBuy, editAddress } from '@/api/index'
  import { parseUrl, throttleTipPop } from '@/assets/utils/utils'
    ...
    data() {
      return {
        ...
        costlist: [
          {
            bttom: '办公用品专属费用',
            imgurl: require('@/assets/images/shopping_cart/bangong.png'),
            imgurls: require('@/assets/images/shopping_cart/bangong_select.png'),
          },
          {
            bttom: '员工福利专属费用',
            imgurl: require('@/assets/images/shopping_cart/yuangong.png'),
            imgurls: require('@/assets/images/shopping_cart/yuangong_select.png'),
          },
          {
            bttom: '营销品专属费用',
            imgurl: require('@/assets/images/shopping_cart/yingxiao.png'),
            imgurls: require('@/assets/images/shopping_cart/yingxiao_select.png'),
          },
        ],
        zhifupay: 0,
        jifen: 1,
