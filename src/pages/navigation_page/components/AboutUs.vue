        ...
        <div class="content">
            ...
            <div class="right">
                <div class="right_title">
                    <h3><span class="slectStatus"></span>关于我们</h3>
                </div>
                <div class="right_nav">
                    <ul class="right_line">
                        <li  @click="handleRightLine(0)" :class="this.rightIndex==0?'liActive':''">
                            <img  class="right_img" src="@/assets/images/navigation_page/aboutUs/aboutUs_03.jpg" alt=""/>
                            联系我们
                        </li>
                        <li @click="handleRightLine(1)" :class="this.rightIndex==1?'liActive':''">
                            <img  class="right_img" src="@/assets/images/navigation_page/aboutUs/aboutUs_05.jpg" alt=""/>
                            人才招聘
                        </li>
                        <li @click="handleRightLine(2)" :class="this.rightIndex==2?'liActive':''">
                            <img  class="right_img" src="@/assets/images/navigation_page/aboutUs/aboutUs_07.jpg" alt=""/>
                            友情链接
                        </li>
