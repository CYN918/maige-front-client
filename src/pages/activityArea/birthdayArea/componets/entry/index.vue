<template>
  <div>
    ...
    <div class="birthday-card">
      <h3 class="birthday-card-title">入职</h3>
        ...
        <li class="birthday-card-01">
          <div class="user-wrap">
            <div class="avantar-wrap">
              ...
              <img class="birthday-avantar" :src='entryPersonal.sex?birthdayPhonto[1].img:birthdayPhonto[0].img' alt="结婚" />
            </div>
            <div class="birthday-name-wrap">
              <span class="birthday-name">{{entryPersonal.userName}}</span>
              <img
                class="icon-button"
      ...
      <div class="pop-up">
        ...
        <ul class="pop-up-content clearfix">
          ...
          >
            ...
            <img class="select-avantar-pic"  :src='entryPersonal.sex?birthdayPhonto[1].img:birthdayPhonto[0].img' alt />
...
export default {
  data(){
    return{
      ...
      userInfo:'',
      birthdayPhonto:[
        {img:require('@/assets/images/birthdayArea/man.png')},
        {img:require('@/assets/images/birthdayArea/wuman.png')}
      ],
      activityTypeId:''
    }
  },
  ...
  computed:{
    ...mapState(['entryPersonal','entryUserId','gifterUserId'])
  },
  methods:{
    //选择人物
    clilkpersonal(index) {
      this.num = index;
      this.$store.commit('entryUserId',this.userInfo[this.num].userId)
    },
    //控制弹窗
    isshowMsg() {
      this.ishow = true;
  ...
  async  showMsg() {
    ...
    pickGift(){
      ...
      this.$router.push('/pickGiftentry')
    },
    //打赏红包
    redEnvelope(){
      if(!this.entryUserId){
      ...
      this.$router.push('/redEnvelopeentry')
    },
    //祝福留言
    blessingMessage(){
      if(!this.entryUserId){
