<template>
    <div class="many_address">
      <div class="many_header clearfix" style="padding-bottom: 20px">
        ...
        <i @click="showMany = true" v-if="!showMany" class="iconfont icon-xiala1" style="cursor: pointer;position: relative;top: 5px;font-size: 20px;color: #409EFF;"></i>
        <i @click="showMany = false" v-else class="iconfont icon-xiala1-copy" style="cursor: pointer;position: relative;top: 5px;font-size: 20px;color: #409EFF;"></i>
      ...
      <div class="many_body" v-show="showMany">
        <div class="many_table clearfix">
          <el-table
            ...
            <div v-for="(item, index) in goodsInfo" :key="`${item.goodsId} + ${Math.random()}`">
              ...
              <el-table-column align="center" label="规格" width="130">
                <template slot-scope="scope">
                  <span :title="item.goodsAttr">{{item.goodsAttr}}</span>
                </template>
              </el-table-column>
